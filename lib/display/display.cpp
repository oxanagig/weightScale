...
void display::displaySensorValue(int valueDisplayLine)
{
    ...
    case LANG_ES:
        ...
        case UNIT_KN:
            ...
            break;
        case UNIT_KGF:
            sprintf(unitStr, "kg-F");
            break;
        //case UNIT_PK :  sprintf(unitStr,"Pc" );break;
        default:
            sprintf(unitStr, "lb-F");
            break;
        }
        break;
    case LANG_DE:
    ...
    if (valueDisplayLine == 0)
    {
        ...
        clearPrintBuffer();
        _u8g2->setFont(u8g2_font_fur30_tn);
    }
    else
    {
...
void display::printToBuffer(char data)
{
    _printBuffer[_bufferIndex++] = data;
    if (PRINT_BUFFER_SIZE == _bufferIndex)
        _bufferIndex = 0;
}

void display::clearPrintBuffer()
{
    _bufferIndex = 0;
}
